...
class Ui_MainWindow(object):
    ...
    def clearPlot(self):
        ...
        #self.graphicsView_signal.removeItem(self.graphicsView_signal)
    ...
    def setInitialRegion(self):
        ...
        self.region.setRegion([np.log10(self.doubleSpinBox_low.value()), np.log10(self.doubleSpinBox_high.value())])#log 1 means e+01
        self.region.sigRegionChanged.connect(self.regionRange)
        self.region.sigRegionChangeFinished.connect(self.regionRangeAndCal)
        self.midPoints()
        self.graphicsView_spectrum.addItem(self.region)#, ignoreBounds=True)
